...
function constructMapUrl () {
    url = "http://127.0.0.1:8080/worldMap?Collection1=" + collection1 + "&Year=" + year;
}

function apiCallForMapData () {
...
function map_variable_1_change (show) {
...
function drawMapView() {
  ...
  var data = jsonVar;//[{"Label":"India","Amount":12312}];
  console.log('data');
  console.log(data);
  ...
  // Navin's Comment - Color Controller
        ...
        .on("mousemove", function(d) {
            ...
            if (d3.event.pageX < map_width / 2) {
              d3.select("#tooltip-container")
                ...
                .style("left", ((d3.event.layerX + map_width + 30) + map_width/2 ) + "px");
            } else {
              var tooltip_width = $("#tooltip-container").width();
              d3.select("#tooltip-container")
                .style("top", (d3.event.layerY + 15) + "px")
                .style("left", ((d3.event.layerX - tooltip_width - 30) + map_width/2) + "px");
            }
        })
